    ...
    >
      {isOpen && (
        <div
          ...
          className={`max-w-[1200px] min-w-[1000px] h-[600px] bg-[url('/assets/image/banner/subpage_bg.jpg')] bg-transparent bg-no-repeat border-solid border-[2px] border-[#fee188] bg-white  p-6 shadow-lg transition-transform duration-300 transform ${
