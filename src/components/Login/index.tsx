        ...
        <>
            {
                !user ?
                    ...
                    :
                    <div className='flex flex-col gap-2 absolute right-[250px] top-0'>
                        <section className="bg-[url('/assets/image/banner/member-logon.png')] bg-no-repeat w-[300px] min-h-[60px] py-5 px-[30px] text-[#d4b072]">
                            <div className='flex my-[10px]'>
                                ...
                                <button onClick={logout} className='bg-red-gradient w-[80px] h-[27px] text-xs rounded text-[#140014]'>Logout</button>
                            </div>
                            <div className='flex items-center text-[#7a5a3d] text-xs'>
                                <span className='cursor-pointer hover:text-[#e2c396] transition-all ease-linear duration-200'>[마이페이지]</span>
                                <span className='cursor-pointer hover:text-[#e2c396] transition-all ease-linear duration-200'>[내쿠폰내역]</span>
                                <span className='cursor-pointer hover:text-[#e2c396] transition-all ease-linear duration-200'>[입/출금내역]</span>
                            </div>
                        </section>
                        <section className="bg-[url('/assets/image/banner/callcenter.png')] bg-no-repeat w-[300px] pt-[55px] bg-contain h-[250px] text-[#d4b072]">
                            <div className='flex ml-8 items-center'>
                                ...
                                <span className='text-white text-[22px] leading-[30px] font-bold'>070 7893 1363</span>
                            </div>
                        </section>
                    </div>
            }
