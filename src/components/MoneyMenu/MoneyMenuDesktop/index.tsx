...
export default function MoneyMenuDesktop() {
  const {
    user,
  ...
  return (
    <section className="moneymenu h-[100px] overflow-hidden bg-[url('/assets/image/money/moneymenu_bg.jpg')] relative hidden xl:block">
